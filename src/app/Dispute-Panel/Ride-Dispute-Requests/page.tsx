...
function Page() {
  ...
  return (
    <div className="relative w-[90vw] overflow-auto md:w-full  shadow-md sm:rounded-lg p-4">
      ...
      <h1 className="text-2xl font-semibold mb-4">Add Ride Dispute</h1>
      <form>
        <div className="mb-4">
          <label htmlFor="disputeType" className="block font-semibold mb-2">Dispute Type</label>
          <select id="disputeType" className="border p-2 w-full">
        ...
        <div className="mb-4 flex">
          <label htmlFor="userProvider" className="block font-semibold mb-2 mr-2">User / Provider</label>
          <input type="text" id="userProvider" className="border p-2 flex-1" />
          <button type="button" className="bg-blue-500 text-white font-semibold py-2 px-4 ml-2 rounded hover:bg-blue-600">Search</button>
        </div>
        <div className="mb-4">
          <label htmlFor="requestDetails" className="block font-semibold mb-2">Request Details</label>
          <textarea id="requestDetails" className="border p-2 w-full h-32"></textarea>
        </div>
        <div className="mb-4">
          <label htmlFor="requestId" className="block font-semibold mb-2">Request Id</label>
          <input type="text" id="requestId" className="border p-2 w-full" />
        </div>
        {/* Add "From", "To", and "Choose" inputs */}
        <div className="mb-4">
          <label className="block font-semibold mb-2">No Results</label>
          <p>No results found.</p>
        </div>
        <div className="mb-4">
          <label htmlFor="reason" className="block font-semibold mb-2">Reason</label>
          <textarea id="reason" className="border p-2 w-full h-32"></textarea>
        </div>
