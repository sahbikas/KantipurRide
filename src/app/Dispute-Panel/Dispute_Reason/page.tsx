            ...
            <DialogContent>
              <div className="max-w-md mx-auto overflow-x-scroll">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <button type="submit" className="bg-blue-500 text-white font-semibold py-2 px-4 rounded hover:bg-blue-600 md:col-start-2 sm:w-[20px] ">Add Dispute Reason</button>
                </form>
              </div>
            </DialogContent>
